...
\usepackage{tikz}
\usetikzlibrary{fadings,calc,hobby, arrows.meta,bending,decorations.markings}
\usepackage{tikz-cd}
...
\NewDocumentCommand\freeDeriv{m}%
{%
	\settowidth{\tableauEntryLength}{\({#1}\)}%
	\addtolength{\tableauEntryLength}{\tableauEntryPadding}%
...
\newcommand*{\geodesicVectorField}{\ensuremath{w}}
% length
