...
A \emph{ribbon}\define{ribbon} is a choice of curve \(\ot{C}\), its \emph{spine}, and a \emph{ruling line}\define{ruling line} \(\ell\) at each point of \(\ot{C}\), perpendicular to the tangent line to \(\ot{C}\), and analytically varying along the spine.
...
Take a nondegenerate ribbon \ in \(\E[3]\) and an analytic isometry \(\iota \colon C \to \ot{C}\).
