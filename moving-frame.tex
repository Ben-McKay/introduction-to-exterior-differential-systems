...
Naturally, we demand that our differential equations be invariant under rigid motion.
...
\begin{center}
\input{curve-with-tangent-frame}
\end{center}
...
\begin{center}
\input{genus-2-surface-with-frame}
\end{center}
...
Take a smooth function \(f\) defined in an open subset of \(\E[3]\).
